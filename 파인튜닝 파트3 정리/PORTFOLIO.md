...
- 남은 결합(조문 번호 오인, 표 구간 혼동)은 암기 의존의 한계 → 2단계의 동기
...
합성 Q&A에 달아둔 근거 띻벨(chunk_id)을 정답지로 재활용해 201개 질문으로 hit@k를 자동 채점.
...
**실험 설계의 핵심은 숫자 홀드아웃**: 학습과 평가에 서로 다른 숫자 조합을 배젵해,
